...
//    do_asc_file ./data/I5LTS.probedex{probedex}.{myzeropadnode} /I5LTSnet/I5LTS[{probedex}]/soma Vm I5LTS{probedex}
...
//    do_asc_file ./data/I5LTSSPIKE.probedex{probedex}.{myzeropadnode} /I5LTSnet/I5LTS[{probedex}]/soma/spk19 state I5LTSSPIKE{probedex}
...
//    do_asc_file ./data/P6RSa.probedex{probedex2}.{myzeropadnode} /P6RSanet/P6RSa[{probedex2}]/soma Vm P6RSa{probedex2}
    do_asc_file ./data/C23FS.probedex{probedex2}.{myzeropadnode} /C23FSnet/C23FS[{probedex2}]/soma Vm C23FS{probedex2}
//    do_asc_file ./data/C5FS.probedex{probedex2}.{myzeropadnode} /C5FSnet/C5FS[{probedex2}]/soma Vm C5FS{probedex2}
//    do_asc_file ./data/ST4RS.probedex{probedex2}.{myzeropadnode} /ST4RSnet/ST4RS[{probedex2}]/soma Vm ST4RS{probedex2}
//    do_asc_file ./data/I23LTS.probedex{probedex2}.{myzeropadnode} /I23LTSnet/I23LTS[{probedex2}]/soma Vm I23LTS{probedex2}
//    do_asc_file ./data/I5LTS.probedex{probedex2}.{myzeropadnode} /I5LTSnet/I5LTS[{probedex2}]/soma Vm I5LTS{probedex2}
...
//    do_asc_file ./data/P6RSaSPIKE.probedex{probedex2}.{myzeropadnode} /P6RSanet/P6RSa[{probedex2}]/soma/spk11 state P6RSaSPIKE{probedex2}
    do_asc_file ./data/C23FSSPIKE.probedex{probedex2}.{myzeropadnode} /C23FSnet/C23FS[{probedex2}]/soma/spk15 state C23FSSPIKE{probedex2}
//    do_asc_file ./data/C5FSSPIKE.probedex{probedex2}.{myzeropadnode} /C5FSnet/C5FS[{probedex2}]/soma/spk16 state C5FSSPIKE{probedex2}
//    do_asc_file ./data/ST4RSSPIKE.probedex{probedex2}.{myzeropadnode} /ST4RSnet/ST4RS[{probedex2}]/soma/spk17 state ST4RSSPIKE{probedex2}
//    do_asc_file ./data/I23LTSSPIKE.probedex{probedex2}.{myzeropadnode} /I23LTSnet/I23LTS[{probedex2}]/soma/spk18 state I23LTSSPIKE{probedex2}
//    do_asc_file ./data/I5LTSSPIKE.probedex{probedex2}.{myzeropadnode} /I5LTSnet/I5LTS[{probedex2}]/soma/spk19 state I5LTSSPIKE{probedex2}
