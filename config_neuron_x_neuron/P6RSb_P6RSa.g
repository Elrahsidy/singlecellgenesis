...
rvolumedelay /P6RSbnet/P6RSb[]/soma/spk12 -radial  {P6RSb_P6RSa_axdelayCV} -add -gaussian {P6RSb_P6RSa_axdelaystdev} {P6RSb_P6RSa_axdelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /P6RSanet/P6RSa[]/{s}/Ex_ch11P6RSAMPA {P6RSb_P6RSa_syndelay} -add -gaussian {P6RSb_P6RSa_syndelaystdev} {P6RSb_P6RSa_syndelaymaxdev}
