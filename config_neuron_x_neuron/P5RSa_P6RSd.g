...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P5RSanet/P5RSa[]/soma/spk23  \
	      /P6RSdnet/P6RSd[]/{s}/Ex_ch14P5RSAMPA@all	    \
	      -relative			    \
	      -sourcemask box -1 -1  -1  1  1  1  \
	      -destmask   box -{destlim} -{destlim}  -1 {destlim}  {destlim}  1   \
	      -desthole   box -0.000001 -0.000001 -0.000001 0.000001 0.000001 0.000001 \
          -probability 0.02326*{P5RSa_P6RSd_prob}
...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P5RSanet/P5RSa[]/soma/spk23  \
	      /P6RSdnet/P6RSd[]/{s}/Ex_ch14P5RSNMDA@all	    \
	      -relative			    \
	      -sourcemask box -1 -1  -1  1  1  1  \
	      -destmask   box -{destlim} -{destlim}  -1 {destlim}  {destlim}  1   \
	      -desthole   box -0.000001 -0.000001 -0.000001 0.000001 0.000001 0.000001 \
...
rvolumedelay /P5RSanet/P5RSa[]/soma/spk23 -radial  {P5RSa_P6RSd_axdelayCV} -add -gaussian {P5RSa_P6RSd_axdelaystdev} {P5RSa_P6RSd_axdelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /P6RSdnet/P6RSd[]/{s}/Ex_ch14P5RSAMPA {P5RSa_P6RSd_syndelay} -add -gaussian {P5RSa_P6RSd_syndelaystdev} {P5RSa_P6RSd_syndelaymaxdev}
