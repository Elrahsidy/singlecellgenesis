...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P5IBbnet/P5IBb[]/soma/spk7  \
          ...
          -probability 0.07692*{P5IBb_P23RSd_prob}
...
rvolumedelay /P5IBbnet/P5IBb[]/soma/spk7 -radial  {P5IBb_P23RSd_axdelayCV} -add -gaussian {P5IBb_P23RSd_axdelaystdev} {P5IBb_P23RSd_axdelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /P23RSdnet/P23RSd[]/{s}/Ex_ch4P5IBAMPA {P5IBb_P23RSd_syndelay} -add -gaussian {P5IBb_P23RSd_syndelaystdev} {P5IBb_P23RSd_syndelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /P23RSdnet/P23RSd[]/{s}/Ex_ch4P5IBNMDA {P5IBb_P23RSd_syndelay} -add -gaussian {P5IBb_P23RSd_syndelaystdev} {P5IBb_P23RSd_syndelaymaxdev}
