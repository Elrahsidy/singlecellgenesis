...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P6RSdnet/P6RSd[]/soma/spk14  \
          ...
          -probability 0.02174*{P6RSd_P5RSa_prob}
...
rvolumedelay /P6RSdnet/P6RSd[]/soma/spk14 -radial  {P6RSd_P5RSa_axdelayCV} -add -gaussian {P6RSd_P5RSa_axdelaystdev} {P6RSd_P5RSa_axdelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /P5RSanet/P5RSa[]/{s}/Ex_ch23P6RSAMPA {P6RSd_P5RSa_syndelay} -add -gaussian {P6RSd_P5RSa_syndelaystdev} {P6RSd_P5RSa_syndelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /P5RSanet/P5RSa[]/{s}/Ex_ch23P6RSNMDA {P6RSd_P5RSa_syndelay} -add -gaussian {P6RSd_P5RSa_syndelaystdev} {P6RSd_P5RSa_syndelaymaxdev}
