...
rvolumedelay /P6RSanet/P6RSa[]/soma/spk11 -radial  {P6RSa_P6RSd_axdelayCV} -add -gaussian {P6RSa_P6RSd_axdelaystdev} {P6RSa_P6RSd_axdelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /P6RSdnet/P6RSd[]/{s}/Ex_ch14P6RSAMPA {P6RSa_P6RSd_syndelay} -add -gaussian {P6RSa_P6RSd_syndelaystdev} {P6RSa_P6RSd_syndelaymaxdev}
