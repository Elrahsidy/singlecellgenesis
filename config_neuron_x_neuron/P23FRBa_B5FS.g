...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P23FRBanet/P23FRBa[]/soma/spk22  \
          ...
          -probability 0.042*{P23FRBa_B5FS_prob}
...
rvolumedelay /P23FRBanet/P23FRBa[]/soma/spk22 -radial  {P23FRBa_B5FS_axdelayCV} -add -gaussian {P23FRBa_B5FS_axdelaystdev} {P23FRBa_B5FS_axdelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /B5FSnet/B5FS[]/{s}/Ex_ch10P23FRBAMPA {P23FRBa_B5FS_syndelay} -add -gaussian {P23FRBa_B5FS_syndelaystdev} {P23FRBa_B5FS_syndelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /B5FSnet/B5FS[]/{s}/Ex_ch10P23FRBNMDA {P23FRBa_B5FS_syndelay} -add -gaussian {P23FRBa_B5FS_syndelaystdev} {P23FRBa_B5FS_syndelaymaxdev}
