...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P5IBcnet/P5IBc[]/soma/spk8  \
          ...
          -probability 0.07692*{P5IBc_P23RSb_prob}
...
rvolumedelay /P5IBcnet/P5IBc[]/soma/spk8 -radial  {P5IBc_P23RSb_axdelayCV} -add -gaussian {P5IBc_P23RSb_axdelaystdev} {P5IBc_P23RSb_axdelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /P23RSbnet/P23RSb[]/{s}/Ex_ch2P5IBAMPA {P5IBc_P23RSb_syndelay} -add -gaussian {P5IBc_P23RSb_syndelaystdev} {P5IBc_P23RSb_syndelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /P23RSbnet/P23RSb[]/{s}/Ex_ch2P5IBNMDA {P5IBc_P23RSb_syndelay} -add -gaussian {P5IBc_P23RSb_syndelaystdev} {P5IBc_P23RSb_syndelaymaxdev}
