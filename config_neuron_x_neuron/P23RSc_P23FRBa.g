...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P23RScnet/P23RSc[]/soma/spk3  \
          ...
          -probability 0.02778*{P23RSc_P23FRBa_prob}
...
rvolumedelay /P23RScnet/P23RSc[]/soma/spk3 -radial  {P23RSc_P23FRBa_axdelayCV} -add -gaussian {P23RSc_P23FRBa_axdelaystdev} {P23RSc_P23FRBa_axdelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /P23FRBanet/P23FRBa[]/{s}/Ex_ch22P23RSAMPA {P23RSc_P23FRBa_syndelay} -add -gaussian {P23RSc_P23FRBa_syndelaystdev} {P23RSc_P23FRBa_syndelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /P23FRBanet/P23FRBa[]/{s}/Ex_ch22P23RSNMDA {P23RSc_P23FRBa_syndelay} -add -gaussian {P23RSc_P23FRBa_syndelaystdev} {P23RSc_P23FRBa_syndelaymaxdev}
