...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P6RSbnet/P6RSb[]/soma/spk12  \
          ...
          -probability 0.042*{P6RSb_B23FS_prob}
...
rvolumedelay /P6RSbnet/P6RSb[]/soma/spk12 -radial  {P6RSb_B23FS_axdelayCV} -add -gaussian {P6RSb_B23FS_axdelaystdev} {P6RSb_B23FS_axdelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /B23FSnet/B23FS[]/{s}/Ex_ch5P6RSAMPA {P6RSb_B23FS_syndelay} -add -gaussian {P6RSb_B23FS_syndelaystdev} {P6RSb_B23FS_syndelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /B23FSnet/B23FS[]/{s}/Ex_ch5P6RSNMDA {P6RSb_B23FS_syndelay} -add -gaussian {P6RSb_B23FS_syndelaystdev} {P6RSb_B23FS_syndelaymaxdev}
