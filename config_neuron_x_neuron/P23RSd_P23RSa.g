...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P23RSdnet/P23RSd[]/soma/spk4  \
          ...
          -probability 0.02778*{P23RSd_P23RSa_prob}
...
rvolumedelay /P23RSdnet/P23RSd[]/soma/spk4 -radial  {P23RSd_P23RSa_axdelayCV} -add -gaussian {P23RSd_P23RSa_axdelaystdev} {P23RSd_P23RSa_axdelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /P23RSanet/P23RSa[]/{s}/Ex_ch1P23RSAMPA {P23RSd_P23RSa_syndelay} -add -gaussian {P23RSd_P23RSa_syndelaystdev} {P23RSd_P23RSa_syndelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /P23RSanet/P23RSa[]/{s}/Ex_ch1P23RSNMDA {P23RSd_P23RSa_syndelay} -add -gaussian {P23RSd_P23RSa_syndelaystdev} {P23RSd_P23RSa_syndelaymaxdev}
