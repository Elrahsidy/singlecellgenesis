...
rvolumedelay /C23FSnet/C23FS[]/soma/spk15 -radial  {C23FS_P6RSb_axdelayCV} -add -gaussian {C23FS_P6RSb_axdelaystdev} {C23FS_P6RSb_axdelaymaxdev}

//C23FS - P6RSb GABAa

syndelay    /P6RSbnet/P6RSb[]/axona/Inh_ch12C23FSGABAa {C23FS_P6RSb_syndelay} -add -gaussian {C23FS_P6RSb_syndelaystdev} {C23FS_P6RSb_syndelaymaxdev}
