...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P23RSdnet/P23RSd[]/soma/spk4  \
          ...
          -probability 0.042*{P23RSd_ST4RS_prob}
...
rvolumedelay /P23RSdnet/P23RSd[]/soma/spk4 -radial  {P23RSd_ST4RS_axdelayCV} -add -gaussian {P23RSd_ST4RS_axdelaystdev} {P23RSd_ST4RS_axdelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /ST4RSnet/ST4RS[]/{s}/Ex_ch17P23RSAMPA {P23RSd_ST4RS_syndelay} -add -gaussian {P23RSd_ST4RS_syndelaystdev} {P23RSd_ST4RS_syndelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /ST4RSnet/ST4RS[]/{s}/Ex_ch17P23RSNMDA {P23RSd_ST4RS_syndelay} -add -gaussian {P23RSd_ST4RS_syndelaystdev} {P23RSd_ST4RS_syndelaymaxdev}
