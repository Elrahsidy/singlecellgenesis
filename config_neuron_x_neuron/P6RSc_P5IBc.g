...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P6RScnet/P6RSc[]/soma/spk13  \
          ...
          -probability 0.02174*{P6RSc_P5IBc_prob}
...
rvolumedelay /P6RScnet/P6RSc[]/soma/spk13 -radial  {P6RSc_P5IBc_axdelayCV} -add -gaussian {P6RSc_P5IBc_axdelaystdev} {P6RSc_P5IBc_axdelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /P5IBcnet/P5IBc[]/{s}/Ex_ch8P6RSAMPA {P6RSc_P5IBc_syndelay} -add -gaussian {P6RSc_P5IBc_syndelaystdev} {P6RSc_P5IBc_syndelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /P5IBcnet/P5IBc[]/{s}/Ex_ch8P6RSNMDA {P6RSc_P5IBc_syndelay} -add -gaussian {P6RSc_P5IBc_syndelaystdev} {P6RSc_P5IBc_syndelaymaxdev}
