...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P5IBanet/P5IBa[]/soma/spk6  \
          ...
          -probability 0.02174*{P5IBa_P5IBb_prob}
...
rvolumedelay /P5IBanet/P5IBa[]/soma/spk6 -radial  {P5IBa_P5IBb_axdelayCV} -add -gaussian {P5IBa_P5IBb_axdelaystdev} {P5IBa_P5IBb_axdelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /P5IBbnet/P5IBb[]/{s}/Ex_ch7P5IBAMPA {P5IBa_P5IBb_syndelay} -add -gaussian {P5IBa_P5IBb_syndelaystdev} {P5IBa_P5IBb_syndelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /P5IBbnet/P5IBb[]/{s}/Ex_ch7P5IBNMDA {P5IBa_P5IBb_syndelay} -add -gaussian {P5IBa_P5IBb_syndelaystdev} {P5IBa_P5IBb_syndelaymaxdev}
