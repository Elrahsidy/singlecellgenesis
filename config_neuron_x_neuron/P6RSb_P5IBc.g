...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P6RSbnet/P6RSb[]/soma/spk12  \
          ...
          -probability 0.02174*{P6RSb_P5IBc_prob}
...
rvolumedelay /P6RSbnet/P6RSb[]/soma/spk12 -radial  {P6RSb_P5IBc_axdelayCV} -add -gaussian {P6RSb_P5IBc_axdelaystdev} {P6RSb_P5IBc_axdelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /P5IBcnet/P5IBc[]/{s}/Ex_ch8P6RSAMPA {P6RSb_P5IBc_syndelay} -add -gaussian {P6RSb_P5IBc_syndelaystdev} {P6RSb_P5IBc_syndelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /P5IBcnet/P5IBc[]/{s}/Ex_ch8P6RSNMDA {P6RSb_P5IBc_syndelay} -add -gaussian {P6RSb_P5IBc_syndelaystdev} {P6RSb_P5IBc_syndelaymaxdev}
