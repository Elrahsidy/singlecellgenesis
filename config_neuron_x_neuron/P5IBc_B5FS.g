...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P5IBcnet/P5IBc[]/soma/spk8  \
	      /B5FSnet/B5FS[]/{s}/Ex_ch10P5IBAMPA@all	    \
	      -relative			    \
	      -sourcemask box -1 -1  -1  1  1  1   \
	      -destmask   box -{destlim} -{destlim}  -1  {destlim}  {destlim}  1   \
	      -desthole   box -0.000001 -0.000001 -0.000001 0.000001 0.000001 0.000001 \
          -probability 0.042*{P5IBc_B5FS_prob}
...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P5IBcnet/P5IBc[]/soma/spk8  \
	      /B5FSnet/B5FS[]/{s}/Ex_ch10P5IBNMDA@all	    \
	      -relative			    \
	      -sourcemask box -1 -1  -1  1  1  1   \
	      -destmask   box -{destlim} -{destlim}  -1  {destlim}  {destlim}  1   \
	      -desthole   box -0.000001 -0.000001 -0.000001 0.000001 0.000001 0.000001 \
...
rvolumedelay /P5IBcnet/P5IBc[]/soma/spk8 -radial  {P5IBc_B5FS_axdelayCV} -add -gaussian {P5IBc_B5FS_axdelaystdev} {P5IBc_B5FS_axdelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /B5FSnet/B5FS[]/{s}/Ex_ch10P5IBAMPA {P5IBc_B5FS_syndelay} -add -gaussian {P5IBc_B5FS_syndelaystdev} {P5IBc_B5FS_syndelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /B5FSnet/B5FS[]/{s}/Ex_ch10P5IBNMDA {P5IBc_B5FS_syndelay} -add -gaussian {P5IBc_B5FS_syndelaystdev} {P5IBc_B5FS_syndelaymaxdev}
