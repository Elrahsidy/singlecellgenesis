...
rvolumedelay /P6RSdnet/P6RSd[]/soma/spk14 -radial  {P6RSd_P6RSb_axdelayCV} -add -gaussian {P6RSd_P6RSb_axdelaystdev} {P6RSd_P6RSb_axdelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /P6RSbnet/P6RSb[]/{s}/Ex_ch12P6RSAMPA {P6RSd_P6RSb_syndelay} -add -gaussian {P6RSd_P6RSb_syndelaystdev} {P6RSd_P6RSb_syndelaymaxdev}
