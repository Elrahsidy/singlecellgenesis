...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /I5LTSnet/I5LTS[]/soma/spk19  \
	      /P5RSanet/P5RSa[]/{s}/Inh_ch23I5LTSGABAa@all	    \
	      -relative			    \
	      -sourcemask box -1 -1  -1  1  1  1  \
	      -destmask   box -{destlim} -{destlim}  -1 {destlim}  {destlim}  1   \
	      -desthole   box -0.000001 -0.000001 -0.000001 0.000001 0.000001 0.000001 \
          -probability 0.02500*{I5LTS_P5RSa_prob}
...
rvolumedelay /I5LTSnet/I5LTS[]/soma/spk19 -radial  {I5LTS_P5RSa_axdelayCV} -add -gaussian {I5LTS_P5RSa_axdelaystdev} {I5LTS_P5RSa_axdelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /P5RSanet/P5RSa[]/{s}/Inh_ch23I5LTSGABAa {I5LTS_P5RSa_syndelay} -add -gaussian {I5LTS_P5RSa_syndelaystdev} {I5LTS_P5RSa_syndelaymaxdev}
