...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P6RSdnet/P6RSd[]/soma/spk14  \
          ...
          -probability 0.042*{P6RSd_ST4RS_prob}
...
rvolumedelay /P6RSdnet/P6RSd[]/soma/spk14 -radial  {P6RSd_ST4RS_axdelayCV} -add -gaussian {P6RSd_ST4RS_axdelaystdev} {P6RSd_S4RS_axdelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /ST4RSnet/ST4RS[]/{s}/Ex_ch17P6RSAMPA {P6RSd_ST4RS_syndelay} -add -gaussian {P6RSd_ST4RS_syndelaystdev} {P6RSd_ST4RS_syndelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /ST4RSnet/ST4RS[]/{s}/Ex_ch17P6RSNMDA {P6RSd_ST4RS_syndelay} -add -gaussian {P6RSd_ST4RS_syndelaystdev} {P6RSd_ST4RS_syndelaymaxdev}
