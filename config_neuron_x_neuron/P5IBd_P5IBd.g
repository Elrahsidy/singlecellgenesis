...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P5IBdnet/P5IBd[]/soma/spk9  \
          ...
          -probability 0.02174*{P5IBd_P5IBd_prob}
...
rvolumedelay /P5IBdnet/P5IBd[]/soma/spk9 -radial  {P5IBd_P5IBd_axdelayCV} -add -gaussian {P5IBd_P5IBd_axdelaystdev} {P5IBd_P5IBd_axdelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /P5IBdnet/P5IBd[]/{s}/Ex_ch9P5IBAMPA {P5IBd_P5IBd_syndelay} -add -gaussian {P5IBd_P5IBd_syndelaystdev} {P5IBd_P5IBd_syndelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /P5IBdnet/P5IBd[]/{s}/Ex_ch9P5IBNMDA {P5IBd_P5IBd_syndelay} -add -gaussian {P5IBd_P5IBd_syndelaystdev} {P5IBd_P5IBd_syndelaymaxdev}
