...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P5IBbnet/P5IBb[]/soma/spk7  \
          ...
          -probability 0.02174*{P5IBb_P5IBd_prob}
...
rvolumedelay /P5IBbnet/P5IBb[]/soma/spk7 -radial  {P5IBb_P5IBd_axdelayCV} -add -gaussian {P5IBb_P5IBd_axdelaystdev} {P5IBb_P5IBd_axdelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /P5IBdnet/P5IBd[]/{s}/Ex_ch9P5IBAMPA {P5IBb_P5IBd_syndelay} -add -gaussian {P5IBb_P5IBd_syndelaystdev} {P5IBb_P5IBd_syndelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /P5IBdnet/P5IBd[]/{s}/Ex_ch9P5IBNMDA {P5IBb_P5IBd_syndelay} -add -gaussian {P5IBb_P5IBd_syndelaystdev} {P5IBb_P5IBd_syndelaymaxdev}
