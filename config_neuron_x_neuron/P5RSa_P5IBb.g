...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P5RSanet/P5RSa[]/soma/spk23  \
	      /P5IBbnet/P5IBb[]/{s}/Ex_ch7P5RSAMPA@all	    \
	      -relative			    \
	      -sourcemask box -1 -1  -1  1  1  1  \
	      -destmask   box -{destlim} -{destlim}  -1 {destlim}  {destlim}  1   \
	      -desthole   box -0.000001 -0.000001 -0.000001 0.000001 0.000001 0.000001 \
          -probability 0.02174*{P5RSa_P5IBb_prob}
...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P5RSanet/P5RSa[]/soma/spk23  \
	      /P5IBbnet/P5IBb[]/{s}/Ex_ch7P5RSNMDA@all	    \
	      -relative			    \
	      -sourcemask box -1 -1  -1  1  1  1  \
	      -destmask   box -{destlim} -{destlim}  -1 {destlim}  {destlim}  1   \
	      -desthole   box -0.000001 -0.000001 -0.000001 0.000001 0.000001 0.000001 \
...
rvolumedelay /P5RSanet/P5RSa[]/soma/spk23 -radial  {P5RSa_P5IBb_axdelayCV} -add -gaussian {P5RSa_P5IBb_axdelaystdev} {P5RSa_P5IBb_axdelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /P5IBbnet/P5IBb[]/{s}/Ex_ch7P5RSAMPA {P5RSa_P5IBb_syndelay} -add -gaussian {P5RSa_P5IBb_syndelaystdev} {P5RSa_P5IBb_syndelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /P5IBbnet/P5IBb[]/{s}/Ex_ch7P5RSNMDA {P5RSa_P5IBb_syndelay} -add -gaussian {P5RSa_P5IBb_syndelaystdev} {P5RSa_P5IBb_syndelaymaxdev}
