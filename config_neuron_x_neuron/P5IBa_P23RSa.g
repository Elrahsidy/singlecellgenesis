...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P5IBanet/P5IBa[]/soma/spk6  \
          ...
          -probability 0.07692*{P5IBa_P23RSa_prob}
...
rvolumedelay /P5IBanet/P5IBa[]/soma/spk6 -radial  {P5IBa_P23RSa_axdelayCV} -add -gaussian {P5IBa_P23RSa_axdelaystdev} {P5IBa_P23RSa_axdelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /P23RSanet/P23RSa[]/{s}/Ex_ch1P5IBAMPA {P5IBa_P23RSa_syndelay} -add -gaussian {P5IBa_P23RSa_syndelaystdev} {P5IBa_P23RSa_syndelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /P23RSanet/P23RSa[]/{s}/Ex_ch1P5IBNMDA {P5IBa_P23RSa_syndelay} -add -gaussian {P5IBa_P23RSa_syndelaystdev} {P5IBa_P23RSa_syndelaymaxdev}
