...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P23RSdnet/P23RSd[]/soma/spk4  \
          ...
          -probability 0.12500*{P23RSd_P6RSc_prob}
...
rvolumedelay /P23RSdnet/P23RSd[]/soma/spk4 -radial  {P23RSd_P6RSc_axdelayCV} -add -gaussian {P23RSd_P6RSc_axdelaystdev} {P23RSd_P6RSc_axdelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /P6RScnet/P6RSc[]/{s}/Ex_ch13P23RSAMPA {P23RSd_P6RSc_syndelay} -add -gaussian {P23RSd_P6RSc_syndelaystdev} {P23RSd_P6RSc_syndelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /P6RScnet/P6RSc[]/{s}/Ex_ch13P23RSNMDA {P23RSd_P6RSc_syndelay} -add -gaussian {P23RSd_P6RSc_syndelaystdev} {P23RSd_P6RSc_syndelaymaxdev}
