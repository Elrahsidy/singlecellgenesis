...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    volumeconnect /P6RSdnet/P6RSd[]/soma/spk14longrange  \
...
// assigning delays
barrierall //ayu
volumedelay /P6RSdnet/P6RSd[]/soma/spk14longrange -radial {{P6RSd_P23FRBa_axdelayCV}*{longrangeCVscale}} -add
...
barrierall //ayu
volumeweight /P6RSdnet/P6RSd[]/soma/spk14longrange -fixed {longrangeweight}
