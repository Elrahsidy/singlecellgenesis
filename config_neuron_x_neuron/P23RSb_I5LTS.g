...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P23RSbnet/P23RSb[]/soma/spk2  \
          ...
          -probability 0.042*{P23RSb_I5LTS_prob}
...
rvolumedelay /P23RSbnet/P23RSb[]/soma/spk2 -radial  {P23RSb_I5LTS_axdelayCV} -add -gaussian {P23RSb_I5LTS_axdelaystdev} {P23RSb_I5LTS_axdelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /I5LTSnet/I5LTS[]/{s}/Ex_ch19P23RSAMPA {P23RSb_I5LTS_syndelay} -add -gaussian {P23RSb_I5LTS_syndelaystdev} {P23RSb_I5LTS_syndelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /I5LTSnet/I5LTS[]/{s}/Ex_ch19P23RSNMDA {P23RSb_I5LTS_syndelay} -add -gaussian {P23RSb_I5LTS_syndelaystdev} {P23RSb_I5LTS_syndelaymaxdev}
