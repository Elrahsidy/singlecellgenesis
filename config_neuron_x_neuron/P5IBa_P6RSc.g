...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P5IBanet/P5IBa[]/soma/spk6  \
          ...
          -probability 0.02326*{P5IBa_P6RSc_prob}
...
rvolumedelay /P5IBanet/P5IBa[]/soma/spk6 -radial  {P5IBa_P6RSc_axdelayCV} -add -gaussian {P5IBa_P6RSc_axdelaystdev} {P5IBa_P6RSc_axdelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /P6RScnet/P6RSc[]/{s}/Ex_ch13P5IBAMPA {P5IBa_P6RSc_syndelay} -add -gaussian {P5IBa_P6RSc_syndelaystdev} {P5IBa_P6RSc_syndelaymaxdev}
