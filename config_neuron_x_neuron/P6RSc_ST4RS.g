...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P6RScnet/P6RSc[]/soma/spk13  \
          ...
          -probability 0.042*{P6RSc_ST4RS_prob}
...
rvolumedelay /P6RScnet/P6RSc[]/soma/spk13 -radial  {P6RSc_ST4RS_axdelayCV} -add -gaussian {P6RSc_ST4RS_axdelaystdev} {P6RSc_S4RS_axdelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /ST4RSnet/ST4RS[]/{s}/Ex_ch17P6RSAMPA {P6RSc_ST4RS_syndelay} -add -gaussian {P6RSc_ST4RS_syndelaystdev} {P6RSc_ST4RS_syndelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /ST4RSnet/ST4RS[]/{s}/Ex_ch17P6RSNMDA {P6RSc_ST4RS_syndelay} -add -gaussian {P6RSc_ST4RS_syndelaystdev} {P6RSc_ST4RS_syndelaymaxdev}
