...
rvolumedelay /P6RSdnet/P6RSd[]/soma/spk14 -radial  {P6RSd_P6RSc_axdelayCV} -add -gaussian {P6RSd_P6RSc_axdelaystdev} {P6RSd_P6RSc_axdelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /P6RScnet/P6RSc[]/{s}/Ex_ch13P6RSAMPA {P6RSd_P6RSc_syndelay} -add -gaussian {P6RSd_P6RSc_syndelaystdev} {P6RSd_P6RSc_syndelaymaxdev}
