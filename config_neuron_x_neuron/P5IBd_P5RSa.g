...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P5IBdnet/P5IBd[]/soma/spk9  \
          ...
          -probability 0.02174*{P5IBd_P5RSa_prob}
...
rvolumedelay /P5IBdnet/P5IBd[]/soma/spk9 -radial  {P5IBd_P5RSa_axdelayCV} -add -gaussian {P5IBd_P5RSa_axdelaystdev} {P5IBd_P5RSa_axdelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /P5RSanet/P5RSa[]/{s}/Ex_ch23P5IBAMPA {P5IBd_P5RSa_syndelay} -add -gaussian {P5IBd_P5RSa_syndelaystdev} {P5IBd_P5RSa_syndelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /P5RSanet/P5RSa[]/{s}/Ex_ch23P5IBNMDA {P5IBd_P5RSa_syndelay} -add -gaussian {P5IBd_P5RSa_syndelaystdev} {P5IBd_P5RSa_syndelaymaxdev}
