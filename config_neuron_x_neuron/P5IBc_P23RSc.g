...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P5IBcnet/P5IBc[]/soma/spk8  \
          ...
          -probability 0.07692*{P5IBc_P23RSc_prob}
...
rvolumedelay /P5IBcnet/P5IBc[]/soma/spk8 -radial  {P5IBc_P23RSc_axdelayCV} -add -gaussian {P5IBc_P23RSc_axdelaystdev} {P5IBc_P23RSc_axdelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /P23RScnet/P23RSc[]/{s}/Ex_ch3P5IBAMPA {P5IBc_P23RSc_syndelay} -add -gaussian {P5IBc_P23RSc_syndelaystdev} {P5IBc_P23RSc_syndelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /P23RScnet/P23RSc[]/{s}/Ex_ch3P5IBNMDA {P5IBc_P23RSc_syndelay} -add -gaussian {P5IBc_P23RSc_syndelaystdev} {P5IBc_P23RSc_syndelaymaxdev}
