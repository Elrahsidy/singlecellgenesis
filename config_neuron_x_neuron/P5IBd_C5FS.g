...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P5IBdnet/P5IBd[]/soma/spk9  \
          ...
          -probability 0.042*{P5IBd_C5FS_prob}
...
rvolumedelay /P5IBdnet/P5IBd[]/soma/spk9 -radial  {P5IBd_C5FS_axdelayCV} -add -gaussian {P5IBd_C5FS_axdelaystdev} {P5IBd_C5FS_axdelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /C5FSnet/C5FS[]/{s}/Ex_ch16P5IBAMPA {P5IBd_C5FS_syndelay} -add -gaussian {P5IBd_C5FS_syndelaystdev} {P5IBd_C5FS_syndelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /C5FSnet/C5FS[]/{s}/Ex_ch16P5IBNMDA {P5IBd_C5FS_syndelay} -add -gaussian {P5IBd_C5FS_syndelaystdev} {P5IBd_C5FS_syndelaymaxdev}
