...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    volumeconnect /P6RScnet/P6RSc[]/soma/spk13longrange  \
...
// assigning delays
barrierall //ayu
volumedelay /P6RScnet/P6RSc[]/soma/spk13longrange -radial {{P6RSc_P23FRBa_axdelayCV}*{longrangeCVscale}} -add
...
barrierall //ayu
volumeweight /P6RScnet/P6RSc[]/soma/spk13longrange -fixed {longrangeweight}
