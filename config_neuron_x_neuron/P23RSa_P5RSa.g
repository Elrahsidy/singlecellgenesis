...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P23RSanet/P23RSa[]/soma/spk1  \
          ...
          -probability 0.12500*{P23RSa_P5RSa_prob}
...
rvolumedelay /P23RSanet/P23RSa[]/soma/spk1 -radial  {P23RSa_P5RSa_axdelayCV} -add -gaussian {P23RSa_P5RSa_axdelaystdev} {P23RSa_P5RSa_axdelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /P5RSanet/P5RSa[]/{s}/Ex_ch23P23RSAMPA {P23RSa_P5RSa_syndelay} -add -gaussian {P23RSa_P5RSa_syndelaystdev} {P23RSa_P5RSa_syndelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /P5RSanet/P5RSa[]/{s}/Ex_ch23P23RSNMDA {P23RSa_P5RSa_syndelay} -add -gaussian {P23RSa_P5RSa_syndelaystdev} {P23RSa_P5RSa_syndelaymaxdev}
