...
rvolumedelay /P6RSdnet/P6RSd[]/soma/spk14 -radial  {P6RSd_P6RSd_axdelayCV} -add -gaussian {P6RSd_P6RSd_axdelaystdev} {P6RSd_P6RSd_axdelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /P6RSdnet/P6RSd[]/{s}/Ex_ch14P6RSAMPA {P6RSd_P6RSd_syndelay} -add -gaussian {P6RSd_P6RSd_syndelaystdev} {P6RSd_P6RSd_syndelaymaxdev}
