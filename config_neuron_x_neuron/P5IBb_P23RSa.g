...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P5IBbnet/P5IBb[]/soma/spk7  \
          ...
          -probability 0.07692*{P5IBb_P23RSa_prob}
...
rvolumedelay /P5IBbnet/P5IBb[]/soma/spk7 -radial  {P5IBb_P23RSa_axdelayCV} -add -gaussian {P5IBb_P23RSa_axdelaystdev} {P5IBb_P23RSa_axdelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /P23RSanet/P23RSa[]/{s}/Ex_ch1P5IBAMPA {P5IBb_P23RSa_syndelay} -add -gaussian {P5IBb_P23RSa_syndelaystdev} {P5IBb_P23RSa_syndelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /P23RSanet/P23RSa[]/{s}/Ex_ch1P5IBNMDA {P5IBb_P23RSa_syndelay} -add -gaussian {P5IBb_P23RSa_syndelaystdev} {P5IBb_P23RSa_syndelaymaxdev}
