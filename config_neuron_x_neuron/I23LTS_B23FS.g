...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /I23LTSnet/I23LTS[]/soma/spk18  \
	      /B23FSnet/B23FS[]/{s}/Inh_ch5I23LTSGABAa@all	    \
	      -relative			    \
	      -sourcemask box -1 -1  -1  1  1  1  \
	      -destmask   box -{destlim} -{destlim}  -1 {destlim}  {destlim}  1   \
	      -desthole   box -0.000001 -0.000001 -0.000001 0.000001 0.000001 0.000001 \
          -probability 0.02500*{I23LTS_B23FS_prob}
...
rvolumedelay /I23LTSnet/I23LTS[]/soma/spk18 -radial  {I23LTS_B23FS_axdelayCV} -add -gaussian {I23LTS_B23FS_axdelaystdev} {I23LTS_B23FS_axdelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /B23FSnet/B23FS[]/{s}/Inh_ch5I23LTSGABAa {I23LTS_B23FS_syndelay} -add -gaussian {I23LTS_B23FS_syndelaystdev} {I23LTS_B23FS_syndelaymaxdev}
