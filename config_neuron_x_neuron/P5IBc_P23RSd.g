...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P5IBcnet/P5IBc[]/soma/spk8  \
          ...
          -probability 0.07692*{P5IBc_P23RSd_prob}
...
rvolumedelay /P5IBcnet/P5IBc[]/soma/spk8 -radial  {P5IBc_P23RSd_axdelayCV} -add -gaussian {P5IBc_P23RSd_axdelaystdev} {P5IBc_P23RSd_axdelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /P23RSdnet/P23RSd[]/{s}/Ex_ch4P5IBAMPA {P5IBc_P23RSd_syndelay} -add -gaussian {P5IBc_P23RSd_syndelaystdev} {P5IBc_P23RSd_syndelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /P23RSdnet/P23RSd[]/{s}/Ex_ch4P5IBNMDA {P5IBc_P23RSd_syndelay} -add -gaussian {P5IBc_P23RSd_syndelaystdev} {P5IBc_P23RSd_syndelaymaxdev}
