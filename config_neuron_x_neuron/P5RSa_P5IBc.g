...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P5RSanet/P5RSa[]/soma/spk23  \
	      /P5IBcnet/P5IBc[]/{s}/Ex_ch8P5RSAMPA@all	    \
	      -relative			    \
	      -sourcemask box -1 -1  -1  1  1  1  \
	      -destmask   box -{destlim} -{destlim}  -1 {destlim}  {destlim}  1   \
	      -desthole   box -0.000001 -0.000001 -0.000001 0.000001 0.000001 0.000001 \
          -probability 0.02174*{P5RSa_P5IBc_prob}
...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P5RSanet/P5RSa[]/soma/spk23  \
	      /P5IBcnet/P5IBc[]/{s}/Ex_ch8P5RSNMDA@all	    \
	      -relative			    \
	      -sourcemask box -1 -1  -1  1  1  1  \
	      -destmask   box -{destlim} -{destlim}  -1 {destlim}  {destlim}  1   \
	      -desthole   box -0.000001 -0.000001 -0.000001 0.000001 0.000001 0.000001 \
...
rvolumedelay /P5RSanet/P5RSa[]/soma/spk23 -radial  {P5RSa_P5IBc_axdelayCV} -add -gaussian {P5RSa_P5IBc_axdelaystdev} {P5RSa_P5IBc_axdelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /P5IBcnet/P5IBc[]/{s}/Ex_ch8P5RSAMPA {P5RSa_P5IBc_syndelay} -add -gaussian {P5RSa_P5IBc_syndelaystdev} {P5RSa_P5IBc_syndelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /P5IBcnet/P5IBc[]/{s}/Ex_ch8P5RSNMDA {P5RSa_P5IBc_syndelay} -add -gaussian {P5RSa_P5IBc_syndelaystdev} {P5RSa_P5IBc_syndelaymaxdev}
