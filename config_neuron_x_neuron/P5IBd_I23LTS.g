...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P5IBdnet/P5IBd[]/soma/spk9  \
          ...
          -probability 0.042*{P5IBd_I23LTS_prob}
...
rvolumedelay /P5IBdnet/P5IBd[]/soma/spk9 -radial  {P5IBd_I23LTS_axdelayCV} -add -gaussian {P5IBd_I23LTS_axdelaystdev} {P5IBd_I23LTS_axdelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /I23LTSnet/I23LTS[]/{s}/Ex_ch18P5IBAMPA {P5IBd_I23LTS_syndelay} -add -gaussian {P5IBd_I23LTS_syndelaystdev} {P5IBd_I23LTS_syndelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /I23LTSnet/I23LTSy[]/{s}/Ex_ch18P5IBNMDA {P5IBd_I23LTS_syndelay} -add -gaussian {P5IBd_I23LTS_syndelaystdev} {P5IBd_I23LTS_syndelaymaxdev}
