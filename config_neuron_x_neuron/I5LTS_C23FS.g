...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /I5LTSnet/I5LTS[]/soma/spk19  \
	      /C23FSnet/C23FS[]/{s}/Inh_ch15I5LTSGABAa@all	    \
	      -relative			    \
	      -sourcemask box -1 -1  -1  1  1  1  \
	      -destmask   box -{destlim} -{destlim}  -1 {destlim}  {destlim}  1   \
	      -desthole   box -0.000001 -0.000001 -0.000001 0.000001 0.000001 0.000001 \
          -probability 0.02500*{I5LTS_C23FS_prob}
...
rvolumedelay /I5LTSnet/I5LTS[]/soma/spk19 -radial  {I5LTS_C23FS_axdelayCV} -add -gaussian {I5LTS_C23FS_axdelaystdev} {I5LTS_C23FS_axdelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /C23FSnet/C23FS[]/{s}/Inh_ch15I5LTSGABAa {I5LTS_C23FS_syndelay} -add -gaussian {I5LTS_C23FS_syndelaystdev} {I5LTS_C23FS_syndelaymaxdev}
