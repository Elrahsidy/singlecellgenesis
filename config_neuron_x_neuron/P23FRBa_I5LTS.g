...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P23FRBanet/P23FRBa[]/soma/spk22  \
	      /I5LTSnet/I5LTS[]/{s}/Ex_ch19P23FRBAMPA@all	    \
	      -relative			    \
	      -sourcemask box -1 -1  -1  1  1  1   \
	      -destmask   box -{destlim} -{destlim}  -1 {destlim}  {destlim}  1   \
	      -desthole   box -0.000001 -0.000001 -0.000001 0.000001 0.000001 0.000001 \
          -probability 0.042*{P23FRBa_I5LTS_prob}
...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P23FRBanet/P23FRBa[]/soma/spk22  \
	      /I5LTSnet/I5LTS[]/{s}/Ex_ch19P23FRBNMDA@all	    \
	      -relative			    \
	      -sourcemask box -1 -1  -1  1  1  1   \
...
rvolumedelay /P23FRBanet/P23FRBa[]/soma/spk22 -radial  {P23FRBa_I5LTS_axdelayCV} -add -gaussian {P23FRBa_I5LTS_axdelaystdev} {P23FRBa_I5LTS_axdelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /I5LTSnet/I5LTS[]/{s}/Ex_ch19P23FRBAMPA {P23FRBa_I5LTS_syndelay} -add -gaussian {P23FRBa_I5LTS_syndelaystdev} {P23FRBa_I5LTS_syndelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /I5LTSnet/I5LTS[]/{s}/Ex_ch19P23FRBNMDA {P23FRBa_I5LTS_syndelay} -add -gaussian {P23FRBa_I5LTS_syndelaystdev} {P23FRBa_I5LTS_syndelaymaxdev}
