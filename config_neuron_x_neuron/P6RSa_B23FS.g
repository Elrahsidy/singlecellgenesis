...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P6RSanet/P6RSa[]/soma/spk11  \
          ...
          -probability 0.042*{P6RSa_B23FS_prob}
...
rvolumedelay /P6RSanet/P6RSa[]/soma/spk11 -radial  {P6RSa_B23FS_axdelayCV} -add -gaussian {P6RSa_B23FS_axdelaystdev} {P6RSa_B23FS_axdelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /B23FSnet/B23FS[]/{s}/Ex_ch5P6RSAMPA {P6RSa_B23FS_syndelay} -add -gaussian {P6RSa_B23FS_syndelaystdev} {P6RSa_B23FS_syndelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /B23FSnet/B23FS[]/{s}/Ex_ch5P6RSNMDA {P6RSa_B23FS_syndelay} -add -gaussian {P6RSa_B23FS_syndelaystdev} {P6RSa_B23FS_syndelaymaxdev}
