...
rvolumedelay /P6RSanet/P6RSa[]/soma/spk11 -radial  {P6RSa_P6RSb_axdelayCV} -add -gaussian {P6RSa_P6RSb_axdelaystdev} {P6RSa_P6RSb_axdelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /P6RSbnet/P6RSb[]/{s}/Ex_ch12P6RSAMPA {P6RSa_P6RSb_syndelay} -add -gaussian {P6RSa_P6RSb_syndelaystdev} {P6RSa_P6RSb_syndelaymaxdev}
