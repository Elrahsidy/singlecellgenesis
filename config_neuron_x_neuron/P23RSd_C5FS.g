...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P23RSdnet/P23RSd[]/soma/spk4  \
          ...
          -probability 0.042*{P23RSd_C5FS_prob}
...
rvolumedelay /P23RSdnet/P23RSd[]/soma/spk4 -radial  {P23RSd_C5FS_axdelayCV} -add -gaussian {P23RSd_C5FS_axdelaystdev} {P23RSd_C5FS_axdelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /C5FSnet/C5FS[]/{s}/Ex_ch16P23RSAMPA {P23RSd_C5FS_syndelay} -add -gaussian {P23RSd_C5FS_syndelaystdev} {P23RSd_C5FS_syndelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /C5FSnet/C5FS[]/{s}/Ex_ch16P23RSNMDA {P23RSd_C5FS_syndelay} -add -gaussian {P23RSd_C5FS_syndelaystdev} {P23RSd_C5FS_syndelaymaxdev}
