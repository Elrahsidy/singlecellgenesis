...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P23FRBanet/P23FRBa[]/soma/spk22longrange  \
	      /I23LTSnet/I23LTS[]/{s}/Ex_ch18I23LTSAMPA@{distantnodes}	    \
	      -relative			    \
	      -sourcemask box -1 -1  -1  1  1  1   \
	      -destmask   box -{destlim} -{destlim}  -1  {destlim}  {destlim}  1   \
	      -desthole   box -0.000001 -0.000001 -0.000001 0.000001 0.000001 0.000001 \
          -probability {longrangeprobscale}*0.02778*{P23FRBa_I23LTS_prob}
          //-probability 0.5
...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    rvolumeconnect /P23FRBanet/P23FRBa[]/soma/spk22longrange  \
	      /I23LTSnet/I23LTS[]/{s}/Ex_ch18I23LTSNMDA@{distantnodes}	    \
	      -relative			    \
	      -sourcemask box -1 -1  -1  1  1  1    \
	      -destmask   box -{destlim} -{destlim}  -1  {destlim}  {destlim}  1   \
	      -desthole   box -0.000001 -0.000001 -0.000001 0.000001 0.000001 0.000001 \
...
barrierall //ayu
rvolumedelay /P23FRBanet/P23FRBa[]/soma/spk22longrange -radial  {P23FRBa_I23LTS_axdelayCV} -add
