...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P23RSbnet/P23RSb[]/soma/spk2  \
          ...
          -probability 0.02778*{P23RSb_P23RSa_prob}
...
rvolumedelay /P23RSbnet/P23RSb[]/soma/spk2 -radial  {P23RSb_P23RSa_axdelayCV} -add -gaussian {P23RSb_P23RSa_axdelaystdev} {P23RSb_P23RSa_axdelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /P23RSanet/P23RSa[]/{s}/Ex_ch1P23RSAMPA {P23RSb_P23RSa_syndelay} -add -gaussian {P23RSb_P23RSa_syndelaystdev} {P23RSb_P23RSa_syndelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /P23RSanet/P23RSa[]/{s}/Ex_ch1P23RSNMDA {P23RSb_P23RSa_syndelay} -add -gaussian {P23RSb_P23RSa_syndelaystdev} {P23RSb_P23RSa_syndelaymaxdev}
