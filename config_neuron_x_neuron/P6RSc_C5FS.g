...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P6RScnet/P6RSc[]/soma/spk13  \
          ...
          -probability 0.042*{P6RSc_C5FS_prob}
...
rvolumedelay /P6RScnet/P6RSc[]/soma/spk13 -radial  {P6RSc_C5FS_axdelayCV} -add -gaussian {P6RSc_C5FS_axdelaystdev} {P6RSc_C5FS_axdelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /C5FSnet/C5FS[]/{s}/Ex_ch16P6RSAMPA {P6RSc_C5FS_syndelay} -add -gaussian {P6RSc_C5FS_syndelaystdev} {P6RSc_C5FS_syndelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /C5FSnet/C5FS[]/{s}/Ex_ch16P6RSNMDA {P6RSc_C5FS_syndelay} -add -gaussian {P6RSc_C5FS_syndelaystdev} {P6RSc_C5FS_syndelaymaxdev}
