...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P5IBcnet/P5IBc[]/soma/spk8  \
          ...
          -probability 0.02174*{P5IBc_P5IBb_prob}
...
rvolumedelay /P5IBcnet/P5IBc[]/soma/spk8 -radial  {P5IBc_P5IBb_axdelayCV} -add -gaussian {P5IBc_P5IBb_axdelaystdev} {P5IBc_P5IBb_axdelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /P5IBbnet/P5IBb[]/{s}/Ex_ch7P5IBAMPA {P5IBc_P5IBb_syndelay} -add -gaussian {P5IBc_P5IBb_syndelaystdev} {P5IBc_P5IBb_syndelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /P5IBbnet/P5IBb[]/{s}/Ex_ch7P5IBNMDA {P5IBc_P5IBb_syndelay} -add -gaussian {P5IBc_P5IBb_syndelaystdev} {P5IBc_P5IBb_syndelaymaxdev}
