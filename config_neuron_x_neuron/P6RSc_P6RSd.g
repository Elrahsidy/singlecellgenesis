...
rvolumedelay /P6RScnet/P6RSc[]/soma/spk13 -radial  {P6RSc_P6RSd_axdelayCV} -add -gaussian {P6RSc_P6RSd_axdelaystdev} {P6RSc_P6RSd_axdelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /P6RSdnet/P6RSd[]/{s}/Ex_ch14P6RSAMPA {P6RSc_P6RSd_syndelay} -add -gaussian {P6RSc_P6RSd_syndelaystdev} {P6RSc_P6RSd_syndelaymaxdev}
