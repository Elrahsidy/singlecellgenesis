...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P5IBbnet/P5IBb[]/soma/spk7  \
          ...
          -probability 0.02326*{P5IBb_P6RSc_prob}
...
rvolumedelay /P5IBbnet/P5IBb[]/soma/spk7 -radial  {P5IBb_P6RSc_axdelayCV} -add -gaussian {P5IBb_P6RSc_axdelaystdev} {P5IBb_P6RSc_axdelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /P6RScnet/P6RSc[]/{s}/Ex_ch13P5IBAMPA {P5IBb_P6RSc_syndelay} -add -gaussian {P5IBb_P6RSc_syndelaystdev} {P5IBb_P6RSc_syndelaymaxdev}
