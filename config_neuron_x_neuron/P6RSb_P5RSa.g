...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P6RSbnet/P6RSb[]/soma/spk12  \
          ...
          -probability 0.02174*{P6RSb_P5RSa_prob}
...
rvolumedelay /P6RSbnet/P6RSb[]/soma/spk12 -radial  {P6RSb_P5RSa_axdelayCV} -add -gaussian {P6RSb_P5RSa_axdelaystdev} {P6RSb_P5RSa_axdelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /P5RSanet/P5RSa[]/{s}/Ex_ch23P6RSAMPA {P6RSb_P5RSa_syndelay} -add -gaussian {P6RSb_P5RSa_syndelaystdev} {P6RSb_P5RSa_syndelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /P5RSanet/P5RSa[]/{s}/Ex_ch23P6RSNMDA {P6RSb_P5RSa_syndelay} -add -gaussian {P6RSb_P5RSa_syndelaystdev} {P6RSb_P5RSa_syndelaymaxdev}
