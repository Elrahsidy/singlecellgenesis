...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P23RSanet/P23RSa[]/soma/spk1  \
          ...
          -probability 0.12500*{P23RSa_P5IBc_prob}
...
rvolumedelay /P23RSanet/P23RSa[]/soma/spk1 -radial  {P23RSa_P5IBc_axdelayCV} -add -gaussian {P23RSa_P5IBc_axdelaystdev} {P23RSa_P5IBc_axdelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /P5IBcnet/P5IBc[]/{s}/Ex_ch8P23RSAMPA {P23RSa_P5IBc_syndelay} -add -gaussian {P23RSa_P5IBc_syndelaystdev} {P23RSa_P5IBc_syndelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /P5IBcnet/P5IBc[]/{s}/Ex_ch8P23RSNMDA {P23RSa_P5IBc_syndelay} -add -gaussian {P23RSa_P5IBc_syndelaystdev} {P23RSa_P5IBc_syndelaymaxdev}
