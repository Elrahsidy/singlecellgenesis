...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /I5LTSnet/I5LTS[]/soma/spk19  \
	      /B5FSnet/B5FS[]/{s}/Inh_ch10I5LTSGABAa@all	    \
	      -relative			    \
	      -sourcemask box -1 -1  -1  1  1  1  \
	      -destmask   box -{destlim} -{destlim}  -1 {destlim}  {destlim}  1   \
	      -desthole   box -0.000001 -0.000001 -0.000001 0.000001 0.000001 0.000001 \
          -probability 0.04200*{I5LTS_B5FS_prob}
...
rvolumedelay /I5LTSnet/I5LTS[]/soma/spk19 -radial  {I5LTS_B5FS_axdelayCV} -add -gaussian {I5LTS_B5FS_axdelaystdev} {I5LTS_B5FS_axdelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /B5FSnet/B5FS[]/{s}/Inh_ch10I5LTSGABAa {I5LTS_B5FS_syndelay} -add -gaussian {I5LTS_B5FS_syndelaystdev} {I5LTS_B5FS_syndelaymaxdev}
