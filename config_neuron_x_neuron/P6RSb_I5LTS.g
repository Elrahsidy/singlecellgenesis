...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P6RSbnet/P6RSb[]/soma/spk12  \
	      /I5LTSnet/I5LTS[]/{s}/Ex_ch19P6RSAMPA@all	    \
	      -relative			    \
	      -sourcemask box -1 -1  -1  1  1  1   \
	      -destmask   box -{destlim} -{destlim}  -1 {destlim}  {destlim}  1   \
	      -desthole   box -0.000001 -0.000001 -0.000001 0.000001 0.000001 0.000001 \
          -probability 0.042*{P6RSb_I5LTS_prob}
...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P6RSbnet/P6RSb[]/soma/spk12  \
	      /I5LTSnet/I5LTS[]/{s}/Ex_ch19P6RSNMDA@all	    \
	      -relative			    \
	      -sourcemask box -1 -1  -1  1  1  1   \
	      -destmask   box -{destlim} -{destlim}  -1 {destlim}  {destlim}  1   \
	      -desthole   box -0.000001 -0.000001 -0.000001 0.000001 0.000001 0.000001 \
...
rvolumedelay /P6RSbnet/P6RSb[]/soma/spk12 -radial  {P6RSb_I5LTS_axdelayCV} -add -gaussian {P6RSb_I5LTS_axdelaystdev} {P6RSb_I5LTS_axdelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /I5LTSnet/I5LTS[]/{s}/Ex_ch19P6RSAMPA {P6RSb_I5LTS_syndelay} -add -gaussian {P6RSb_I5LTS_syndelaystdev} {P6RSb_I5LTS_syndelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /I5LTSnet/I5LTS[]/{s}/Ex_ch19P6RSNMDA {P6RSb_I5LTS_syndelay} -add -gaussian {P6RSb_I5LTS_syndelaystdev} {P6RSb_I5LTS_syndelaymaxdev}
