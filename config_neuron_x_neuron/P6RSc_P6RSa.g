...
rvolumedelay /P6RScnet/P6RSc[]/soma/spk13 -radial  {P6RSc_P6RSa_axdelayCV} -add -gaussian {P6RSc_P6RSa_axdelaystdev} {P6RSc_P6RSa_axdelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /P6RSanet/P6RSa[]/{s}/Ex_ch11P6RSAMPA {P6RSc_P6RSa_syndelay} -add -gaussian {P6RSc_P6RSa_syndelaystdev} {P6RSc_P6RSa_syndelaymaxdev}
