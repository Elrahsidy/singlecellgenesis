...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P5IBdnet/P5IBd[]/soma/spk9  \
          ...
          -probability 0.07692*{P5IBd_P23FRBa_prob}
...
rvolumedelay /P5IBdnet/P5IBd[]/soma/spk9 -radial  {P5IBd_P23FRBa_axdelayCV} -add -gaussian {P5IBd_P23FRBa_axdelaystdev} {P5IBd_P23FRBa_axdelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /P23FRBanet/P23FRBa[]/{s}/Ex_ch22P5IBAMPA {P5IBd_P23FRBa_syndelay} -add -gaussian {P5IBd_P23FRBa_syndelaystdev} {P5IBd_P23FRBa_syndelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /P23FRBanet/P23FRBa[]/{s}/Ex_ch22P5IBNMDA {P5IBd_P23FRBa_syndelay} -add -gaussian {P5IBd_P23FRBa_syndelaystdev} {P5IBd_P23FRBa_syndelaymaxdev}
