...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P6RSdnet/P6RSd[]/soma/spk14  \
	      /C23FSnet/C23FS[]/{s}/Ex_ch15P6RSAMPA@all	    \
	      -relative			    \
	      -sourcemask box -1 -1  -1  1  1  1   \
	      -destmask   box -{destlim} -{destlim}  -1 {destlim}  {destlim}  1   \
	      -desthole   box -0.000001 -0.000001 -0.000001 0.000001 0.000001 0.000001 \
          -probability 0.042*{P6RSd_C23FS_prob}
...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P6RSdnet/P6RSd[]/soma/spk14  \
	      /C23FSnet/C23FS[]/{s}/Ex_ch15P6RSNMDA@all	    \
	      -relative			    \
	      -sourcemask box -1 -1  -1  1  1  1   \
	      -destmask   box -{destlim} -{destlim}  -1 {destlim}  {destlim}  1   \
	      -desthole   box -0.000001 -0.000001 -0.000001 0.000001 0.000001 0.000001 \
...
rvolumedelay /P6RSdnet/P6RSd[]/soma/spk14 -radial  {P6RSd_C23FS_axdelayCV} -add -gaussian {P6RSd_C23FS_axdelaystdev} {P6RSd_C23FS_axdelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /C23FSnet/C23FS[]/{s}/Ex_ch15P6RSAMPA {P6RSd_C23FS_syndelay} -add -gaussian {P6RSd_C23FS_syndelaystdev} {P6RSd_C23FS_syndelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /C23FSnet/C23FS[]/{s}/Ex_ch15P6RSNMDA {P6RSd_C23FS_syndelay} -add -gaussian {P6RSd_C23FS_syndelaystdev} {P6RSd_C23FS_syndelaymaxdev}
