...
rvolumedelay /P6RSbnet/P6RSb[]/soma/spk12 -radial  {P6RSb_P6RSc_axdelayCV} -add -gaussian {P6RSb_P6RSc_axdelaystdev} {P6RSb_P6RSc_axdelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /P6RScnet/P6RSc[]/{s}/Ex_ch13P6RSAMPA {P6RSb_P6RSc_syndelay} -add -gaussian {P6RSb_P6RSc_syndelaystdev} {P6RSb_P6RSc_syndelaymaxdev}
