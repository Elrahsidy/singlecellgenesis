...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P5IBcnet/P5IBc[]/soma/spk8  \
          ...
          -probability 0.02174*{P5IBc_P5IBd_prob}
...
rvolumedelay /P5IBcnet/P5IBc[]/soma/spk8 -radial  {P5IBc_P5IBd_axdelayCV} -add -gaussian {P5IBc_P5IBd_axdelaystdev} {P5IBc_P5IBd_axdelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /P5IBdnet/P5IBd[]/{s}/Ex_ch9P5IBAMPA {P5IBc_P5IBd_syndelay} -add -gaussian {P5IBc_P5IBd_syndelaystdev} {P5IBc_P5IBd_syndelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /P5IBdnet/P5IBd[]/{s}/Ex_ch9P5IBNMDA {P5IBc_P5IBd_syndelay} -add -gaussian {P5IBc_P5IBd_syndelaystdev} {P5IBc_P5IBd_syndelaymaxdev}
