...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P23RSanet/P23RSa[]/soma/spk1  \
          ...
          -probability 0.042*{P23RSa_ST4RS_prob}
...
rvolumedelay /P23RSanet/P23RSa[]/soma/spk1 -radial  {P23RSa_ST4RS_axdelayCV} -add -gaussian {P23RSa_ST4RS_axdelaystdev} {P23RSa_ST4RS_axdelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /ST4RSnet/ST4RS[]/{s}/Ex_ch17P23RSAMPA {P23RSa_ST4RS_syndelay} -add -gaussian {P23RSa_ST4RS_syndelaystdev} {P23RSa_ST4RS_syndelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /ST4RSnet/ST4RS[]/{s}/Ex_ch17P23RSNMDA {P23RSa_ST4RS_syndelay} -add -gaussian {P23RSa_ST4RS_syndelaystdev} {P23RSa_ST4RS_syndelaymaxdev}
