...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P6RSbnet/P6RSb[]/soma/spk12  \
	      /P6RSdnet/P6RSd[]/{s}/Ex_ch14P6RSAMPA@all	    \
	      -relative			    \
...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P6RSbnet/P6RSb[]/soma/spk12  \
	      /P6RSdnet/P6RSd[]/{s}/Ex_ch14P6RSNMDA@all	    \
	      -relative			    \
	      -sourcemask box -1 -1  -1  1  1  1  \
	      -destmask   box -{destlim} -{destlim}  -1 {destlim}  {destlim}  1   \
	      -desthole   box -0.000001 -0.000001 -0.000001 0.000001 0.000001 0.000001 \
...
rvolumedelay /P6RSbnet/P6RSb[]/soma/spk12 -radial  {P6RSb_P6RSd_axdelayCV} -add -gaussian {P6RSb_P6RSd_axdelaystdev} {P6RSb_P6RSd_axdelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /P6RSdnet/P6RSd[]/{s}/Ex_ch14P6RSAMPA {P6RSb_P6RSd_syndelay} -add -gaussian {P6RSb_P6RSd_syndelaystdev} {P6RSb_P6RSd_syndelaymaxdev}
