...
rvolumedelay /P6RSanet/P6RSa[]/soma/spk11 -radial  {P6RSa_P6RSc_axdelayCV} -add -gaussian {P6RSa_P6RSc_axdelaystdev} {P6RSa_P6RSc_axdelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /P6RScnet/P6RSc[]/{s}/Ex_ch13P6RSAMPA {P6RSa_P6RSc_syndelay} -add -gaussian {P6RSa_P6RSc_syndelaystdev} {P6RSa_P6RSc_syndelaymaxdev}
