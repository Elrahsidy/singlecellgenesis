...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P6RSbnet/P6RSb[]/soma/spk12  \
          ...
          -probability 0.01111*{P6RSb_TCR_prob}
...
rvolumedelay /P6RSbnet/P6RSb[]/soma/spk12 -fixed  {P6RSb_TCR_axdelayCV} -add -gaussian {P6RSb_TCR_axdelaystdev} {P6RSb_TCR_axdelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /TCRnet/TCR[]/{s}/Ex_ch20P6RSAMPA {P6RSb_TCR_syndelay} -add -gaussian {P6RSb_TCR_syndelaystdev} {P6RSb_TCR_syndelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /TCRnet/TCR[]/{s}/Ex_ch20P6RSNMDA {P6RSb_TCR_syndelay} -add -gaussian {P6RSb_TCR_syndelaystdev} {P6RSb_TCR_syndelaymaxdev}
