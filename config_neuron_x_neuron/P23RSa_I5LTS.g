...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P23RSanet/P23RSa[]/soma/spk1  \
          ...
          -probability 0.042*{P23RSa_I5LTS_prob}
...
rvolumedelay /P23RSanet/P23RSa[]/soma/spk1 -radial  {P23RSa_I5LTS_axdelayCV} -add -gaussian {P23RSa_I5LTS_axdelaystdev} {P23RSa_I5LTS_axdelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /I5LTSnet/I5LTS[]/{s}/Ex_ch19P23RSAMPA {P23RSa_I5LTS_syndelay} -add -gaussian {P23RSa_I5LTS_syndelaystdev} {P23RSa_I5LTS_syndelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /I5LTSnet/I5LTS[]/{s}/Ex_ch19P23RSNMDA {P23RSa_I5LTS_syndelay} -add -gaussian {P23RSa_I5LTS_syndelaystdev} {P23RSa_I5LTS_syndelaymaxdev}
