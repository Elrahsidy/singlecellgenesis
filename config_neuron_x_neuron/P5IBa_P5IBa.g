...
rvolumedelay /P5IBanet/P5IBa[]/soma/spk6 -radial  {P5IBa_P5IBa_axdelayCV} -add -gaussian {P5IBa_P5IBa_axdelaystdev} {P5IBa_P5IBa_axdelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /P5IBanet/P5IBa[]/{s}/Ex_ch6P5IBAMPA {P5IBa_P5IBa_syndelay} -add -gaussian {P5IBa_P5IBa_syndelaystdev} {P5IBa_P5IBa_syndelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /P5IBanet/P5IBa[]/{s}/Ex_ch6P5IBNMDA {P5IBa_P5IBa_syndelay} -add -gaussian {P5IBa_P5IBa_syndelaystdev} {P5IBa_P5IBa_syndelaymaxdev}
