...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P6RSanet/P6RSa[]/soma/spk11  \
	      /TCRnet/TCR[]/{s}/Ex_ch20P6RSAMPA@all	    \
	      -relative			    \
	      -sourcemask box -1 -1  -1  1  1  1   \
	      -destmask   box -{destlim} -{destlim}  -1 {destlim}  {destlim}  1   \
	      -desthole   box -0.000001 -0.000001 -0.000001 0.000001 0.000001 0.000001 \
          -probability 0.01111*{P6RSa_TCR_prob}
...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P6RSanet/P6RSa[]/soma/spk11  \
	      /TCRnet/TCR[]/{s}/Ex_ch20P6RSNMDA@all	    \
	      -relative			    \
	      -sourcemask box -1 -1  -1  1  1  1   \
	      -destmask   box -{destlim} -{destlim}  -1 {destlim}  {destlim}  1   \
	      -desthole   box -0.000001 -0.000001 -0.000001 0.000001 0.000001 0.000001 \
...
rvolumedelay /P6RSanet/P6RSa[]/soma/spk11 -fixed  {P6RSa_TCR_axdelayCV} -add -gaussian {P6RSa_TCR_axdelaystdev} {P6RSa_TCR_axdelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /TCRnet/TCR[]/{s}/Ex_ch20P6RSAMPA {P6RSa_TCR_syndelay} -add -gaussian {P6RSa_TCR_syndelaystdev} {P6RSa_TCR_syndelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /TCRnet/TCR[]/{s}/Ex_ch20P6RSNMDA {P6RSa_TCR_syndelay} -add -gaussian {P6RSa_TCR_syndelaystdev} {P6RSa_TCR_syndelaymaxdev}
