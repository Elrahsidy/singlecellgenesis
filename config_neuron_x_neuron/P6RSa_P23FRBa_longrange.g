...
foreach s ({arglist {locations}})
    ...
    barrierall //ayu
    volumeconnect /P6RSanet/P6RSa[]/soma/spk11longrange  \
...
// assigning delays
barrierall //ayu
volumedelay /P6RSanet/P6RSa[]/soma/spk11longrange -radial {{P6RSa_P23FRBa_axdelayCV}*{longrangeCVscale}} -add
...
barrierall //ayu
volumeweight /P6RSanet/P6RSa[]/soma/spk11longrange -fixed {longrangeweight}
