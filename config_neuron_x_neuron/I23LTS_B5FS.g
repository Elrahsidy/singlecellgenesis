...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /I23LTSnet/I23LTS[]/soma/spk18  \
	      /B5FSnet/B5FS[]/{s}/Inh_ch10I23LTSGABAa@all	    \
	      -relative			    \
	      -sourcemask box -1 -1  -1  1  1  1  \
	      -destmask   box -{destlim} -{destlim}  -1 {destlim}  {destlim}  1   \
	      -desthole   box -0.000001 -0.000001 -0.000001 0.000001 0.000001 0.000001 \
          -probability 0.04200*{I23LTS_B5FS_prob}
...
rvolumedelay /I23LTSnet/I23LTS[]/soma/spk18 -radial  {I23LTS_B5FS_axdelayCV} -add -gaussian {I23LTS_B5FS_axdelaystdev} {I23LTS_B5FS_axdelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /B5FSnet/B5FS[]/{s}/Inh_ch10I23LTSGABAa {I23LTS_B5FS_syndelay} -add -gaussian {I23LTS_B5FS_syndelaystdev} {I23LTS_B5FS_syndelaymaxdev}
