...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P5IBcnet/P5IBc[]/soma/spk8  \
	      /P6RSdnet/P6RSd[]/{s}/Ex_ch14P5IBAMPA@all	    \
	      -relative			    \
	      -sourcemask box -1 -1  -1  1  1  1  \
	      -destmask   box -{destlim} -{destlim}  -1  {destlim}  {destlim}  1  \
	      -desthole   box -0.000001 -0.000001 -0.000001 0.000001 0.000001 0.000001 \
          -probability 0.02326*{P5IBc_P6RSd_prob}
...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P5IBcnet/P5IBc[]/soma/spk8  \
	      /P6RSdnet/P6RSd[]/{s}/Ex_ch14P5IBNMDA@all	    \
	      -relative			    \
	      -sourcemask box -1 -1  -1  1  1  1  \
	      -destmask   box -{destlim} -{destlim}  -1  {destlim}  {destlim}  1   \
	      -desthole   box -0.000001 -0.000001 -0.000001 0.000001 0.000001 0.000001 \
...
rvolumedelay /P5IBcnet/P5IBc[]/soma/spk8 -radial  {P5IBc_P6RSd_axdelayCV} -add -gaussian {P5IBc_P6RSd_axdelaystdev} {P5IBc_P6RSd_axdelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /P6RSdnet/P6RSd[]/{s}/Ex_ch14P5IBAMPA {P5IBc_P6RSd_syndelay} -add -gaussian {P5IBc_P6RSd_syndelaystdev} {P5IBc_P6RSd_syndelaymaxdev}
