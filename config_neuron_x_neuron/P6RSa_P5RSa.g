...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P6RSanet/P6RSa[]/soma/spk11  \
          ...
          -probability 0.02174*{P6RSa_P5RSa_prob}
...
rvolumedelay /P6RSanet/P6RSa[]/soma/spk11 -radial  {P6RSa_P5RSa_axdelayCV} -add -gaussian {P6RSa_P5RSa_axdelaystdev} {P6RSa_P5RSa_axdelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /P5RSanet/P5RSa[]/{s}/Ex_ch23P6RSAMPA {P6RSa_P5RSa_syndelay} -add -gaussian {P6RSa_P5RSa_syndelaystdev} {P6RSa_P5RSa_syndelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /P5RSanet/P5RSa[]/{s}/Ex_ch23P6RSNMDA {P6RSa_P5RSa_syndelay} -add -gaussian {P6RSa_P5RSa_syndelaystdev} {P6RSa_P5RSa_syndelaymaxdev}
