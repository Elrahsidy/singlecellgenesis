...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P5RSanet/P5RSa[]/soma/spk23  \
	      /B5FSnet/B5FS[]/{s}/Ex_ch10P5RSAMPA@all	    \
	      -relative			    \
	      -sourcemask box -1 -1  -1  1  1  1   \
	      -destmask   box -{destlim} -{destlim}  -1 {destlim}  {destlim}  1   \
	      -desthole   box -0.000001 -0.000001 -0.000001 0.000001 0.000001 0.000001 \
          -probability 0.042*{P5RSa_B5FS_prob}
...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P5RSanet/P5RSa[]/soma/spk23  \
	      /B5FSnet/B5FS[]/{s}/Ex_ch10P5RSNMDA@all	    \
	      -relative			    \
	      -sourcemask box -1 -1  -1  1  1  1   \
	      -destmask   box -{destlim} -{destlim}  -1 {destlim}  {destlim}  1   \
	      -desthole   box -0.000001 -0.000001 -0.000001 0.000001 0.000001 0.000001 \
...
rvolumedelay /P5RSanet/P5RSa[]/soma/spk23 -radial  {P5RSa_B5FS_axdelayCV} -add -gaussian {P5RSa_B5FS_axdelaystdev} {P5RSa_B5FS_axdelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /B5FSnet/B5FS[]/{s}/Ex_ch10P5RSAMPA {P5RSa_B5FS_syndelay} -add -gaussian {P5RSa_B5FS_syndelaystdev} {P5RSa_B5FS_syndelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /B5FSnet/B5FS[]/{s}/Ex_ch10P5RSNMDA {P5RSa_B5FS_syndelay} -add -gaussian {P5RSa_B5FS_syndelaystdev} {P5RSa_B5FS_syndelaymaxdev}
