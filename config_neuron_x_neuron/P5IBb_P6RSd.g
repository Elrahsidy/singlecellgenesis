...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P5IBbnet/P5IBb[]/soma/spk7  \
          ...
          -probability 0.02326*{P5IBb_P6RSd_prob}
...
rvolumedelay /P5IBbnet/P5IBb[]/soma/spk7 -radial  {P5IBb_P6RSd_axdelayCV} -add -gaussian {P5IBb_P6RSd_axdelaystdev} {P5IBb_P6RSd_axdelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /P6RSdnet/P6RSd[]/{s}/Ex_ch14P5IBAMPA {P5IBb_P6RSd_syndelay} -add -gaussian {P5IBb_P6RSd_syndelaystdev} {P5IBb_P6RSd_syndelaymaxdev}
