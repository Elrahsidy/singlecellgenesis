...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P6RSanet/P6RSa[]/soma/spk11  \
	      /P6RSanet/P6RSa[]/{s}/Ex_ch11P6RSAMPA@all	    \
	      -relative			    \
...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P6RSanet/P6RSa[]/soma/spk11  \
	      /P6RSanet/P6RSa[]/{s}/Ex_ch11P6RSNMDA@all	    \
	      -relative			    \
	      -sourcemask box -1 -1  -1  1  1  1  \
	      -destmask   box -{destlim} -{destlim}  -1 {destlim}  {destlim}  1   \
	      -desthole   box -0.000001 -0.000001 -0.000001 0.000001 0.000001 0.000001 \
...
rvolumedelay /P6RSanet/P6RSa[]/soma/spk11 -radial  {P6RSa_P6RSa_axdelayCV} -add -gaussian {P6RSa_P6RSa_axdelaystdev} {P6RSa_P6RSa_axdelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /P6RSanet/P6RSa[]/{s}/Ex_ch11P6RSAMPA {P6RSa_P6RSa_syndelay} -add -gaussian {P6RSa_P6RSa_syndelaystdev} {P6RSa_P6RSa_syndelaymaxdev}
