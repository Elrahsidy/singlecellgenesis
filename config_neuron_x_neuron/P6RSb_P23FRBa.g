...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P6RSbnet/P6RSb[]/soma/spk12  \
          ...
          -probability 0.25000*{P6RSb_P23FRBa_prob}
...
rvolumedelay /P6RSbnet/P6RSb[]/soma/spk12 -radial  {P6RSb_P23FRBa_axdelayCV} -add -gaussian {P6RSb_P23FRBa_axdelaystdev} {P6RSb_P23FRBa_axdelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /P23FRBanet/P23FRBa[]/{s}/Ex_ch22P6RSAMPA {P6RSb_P23FRBa_syndelay} -add -gaussian {P6RSb_P23FRBa_syndelaystdev} {P6RSb_P23FRBa_syndelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /P23FRBanet/P23FRBa[]/{s}/Ex_ch22P6RSNMDA {P6RSb_P23FRBa_syndelay} -add -gaussian {P6RSb_P23FRBa_syndelaystdev} {P6RSb_P23FRBa_syndelaymaxdev}
