...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P5IBdnet/P5IBd[]/soma/spk9  \
          ...
          -probability 0.02326*{P5IBd_P6RSa_prob}
...
rvolumedelay /P5IBdnet/P5IBd[]/soma/spk9 -radial  {P5IBd_P6RSa_axdelayCV} -add -gaussian {P5IBd_P6RSa_axdelaystdev} {P5IBd_P6RSa_axdelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /P6RSanet/P6RSa[]/{s}/Ex_ch11P5IBAMPA {P5IBd_P6RSa_syndelay} -add -gaussian {P5IBd_P6RSa_syndelaystdev} {P5IBd_P6RSa_syndelaymaxdev}
