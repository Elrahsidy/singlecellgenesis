...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P5IBbnet/P5IBb[]/soma/spk7  \
          ...
          -probability 0.02326*{P5IBb_P6RSa_prob}
...
rvolumedelay /P5IBbnet/P5IBb[]/soma/spk7 -radial  {P5IBb_P6RSa_axdelayCV} -add -gaussian {P5IBb_P6RSa_axdelaystdev} {P5IBb_P6RSa_axdelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /P6RSanet/P6RSa[]/{s}/Ex_ch11P5IBAMPA {P5IBb_P6RSa_syndelay} -add -gaussian {P5IBb_P6RSa_syndelaystdev} {P5IBb_P6RSa_syndelaymaxdev}
