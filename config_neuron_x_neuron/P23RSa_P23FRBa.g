...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P23RSanet/P23RSa[]/soma/spk1  \
          ...
          -probability 0.02778*{P23RSa_P23FRBa_prob}
...
rvolumedelay /P23RSanet/P23RSa[]/soma/spk1 -radial  {P23RSa_P23FRBa_axdelayCV} -add -gaussian {P23RSa_P23FRBa_axdelaystdev} {P23RSa_P23FRBa_axdelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /P23FRBanet/P23FRBa[]/{s}/Ex_ch22P23RSAMPA {P23RSa_P23FRBa_syndelay} -add -gaussian {P23RSa_P23FRBa_syndelaystdev} {P23RSa_P23FRBa_syndelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /P23FRBanet/P23FRBa[]/{s}/Ex_ch22P23RSNMDA {P23RSa_P23FRBa_syndelay} -add -gaussian {P23RSa_P23FRBa_syndelaystdev} {P23RSa_P23FRBa_syndelaymaxdev}
