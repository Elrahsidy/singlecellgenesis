...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P5IBbnet/P5IBb[]/soma/spk7  \
          ...
          -probability 0.042*{P5IBb_I23LTS_prob}
...
rvolumedelay /P5IBbnet/P5IBb[]/soma/spk7 -radial  {P5IBb_I23LTS_axdelayCV} -add -gaussian {P5IBb_I23LTS_axdelaystdev} {P5IBb_I23LTS_axdelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /I23LTSnet/I23LTS[]/{s}/Ex_ch18P5IBAMPA {P5IBb_I23LTS_syndelay} -add -gaussian {P5IBb_I23LTS_syndelaystdev} {P5IBb_I23LTS_syndelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /I23LTSnet/I23LTS[]/{s}/Ex_ch18P5IBNMDA {P5IBb_I23LTS_syndelay} -add -gaussian {P5IBb_I23LTS_syndelaystdev} {P5IBb_I23LTS_syndelaymaxdev}
