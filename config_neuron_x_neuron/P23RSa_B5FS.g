...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P23RSanet/P23RSa[]/soma/spk1  \
          ...
          -probability 0.042*{P23RSa_B5FS_prob}
...
rvolumedelay /P23RSanet/P23RSa[]/soma/spk1 -radial  {P23RSa_B5FS_axdelayCV} -add -gaussian {P23RSa_B5FS_axdelaystdev} {P23RSa_B5FS_axdelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /B5FSnet/B5FS[]/{s}/Ex_ch10P23RSAMPA {P23RSa_B5FS_syndelay} -add -gaussian {P23RSa_B5FS_syndelaystdev} {P23RSa_B5FS_syndelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /B5FSnet/B5FS[]/{s}/Ex_ch10P23RSNMDA {P23RSa_B5FS_syndelay} -add -gaussian {P23RSa_B5FS_syndelaystdev} {P23RSa_B5FS_syndelaymaxdev}
