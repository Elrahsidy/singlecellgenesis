...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P5IBdnet/P5IBd[]/soma/spk9  \
          ...
          -probability 0.02326*{P5IBd_P6RSd_prob}
...
rvolumedelay /P5IBdnet/P5IBd[]/soma/spk9 -radial  {P5IBd_P6RSd_axdelayCV} -add -gaussian {P5IBd_P6RSd_axdelaystdev} {P5IBd_P6RSd_axdelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /P6RSdnet/P6RSd[]/{s}/Ex_ch14P5IBAMPA {P5IBd_P6RSd_syndelay} -add -gaussian {P5IBd_P6RSd_syndelaystdev} {P5IBd_P6RSd_syndelaymaxdev}
