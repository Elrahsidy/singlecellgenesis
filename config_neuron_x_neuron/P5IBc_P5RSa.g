...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P5IBcnet/P5IBc[]/soma/spk8  \
          ...
          -probability 0.02174*{P5IBc_P5RSa_prob}
...
rvolumedelay /P5IBcnet/P5IBc[]/soma/spk8 -radial  {P5IBc_P5RSa_axdelayCV} -add -gaussian {P5IBc_P5RSa_axdelaystdev} {P5IBc_P5RSa_axdelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /P5RSanet/P5RSa[]/{s}/Ex_ch23P5IBAMPA {P5IBc_P5RSa_syndelay} -add -gaussian {P5IBc_P5RSa_syndelaystdev} {P5IBc_P5RSa_syndelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /P5RSanet/P5RSa[]/{s}/Ex_ch23P5IBNMDA {P5IBc_P5RSa_syndelay} -add -gaussian {P5IBc_P5RSa_syndelaystdev} {P5IBc_P5RSa_syndelaymaxdev}
