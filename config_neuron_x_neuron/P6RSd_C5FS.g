...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P6RSdnet/P6RSd[]/soma/spk14  \
          ...
          -probability 0.042*{P6RSd_C5FS_prob}
...
rvolumedelay /P6RSdnet/P6RSd[]/soma/spk14 -radial  {P6RSd_C5FS_axdelayCV} -add -gaussian {P6RSd_C5FS_axdelaystdev} {P6RSd_C5FS_axdelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /C5FSnet/C5FS[]/{s}/Ex_ch16P6RSAMPA {P6RSd_C5FS_syndelay} -add -gaussian {P6RSd_C5FS_syndelaystdev} {P6RSd_C5FS_syndelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /C5FSnet/C5FS[]/{s}/Ex_ch16P6RSNMDA {P6RSd_C5FS_syndelay} -add -gaussian {P6RSd_C5FS_syndelaystdev} {P6RSd_C5FS_syndelaymaxdev}
