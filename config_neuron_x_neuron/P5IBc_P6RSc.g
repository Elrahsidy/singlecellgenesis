...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P5IBcnet/P5IBc[]/soma/spk8  \
          ...
          -probability 0.02326*{P5IBc_P6RSc_prob}
...
rvolumedelay /P5IBcnet/P5IBc[]/soma/spk8 -radial  {P5IBc_P6RSc_axdelayCV} -add -gaussian {P5IBc_P6RSc_axdelaystdev} {P5IBc_P6RSc_axdelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /P6RScnet/P6RSc[]/{s}/Ex_ch13P5IBAMPA {P5IBc_P6RSc_syndelay} -add -gaussian {P5IBc_P6RSc_syndelaystdev} {P5IBc_P6RSc_syndelaymaxdev}
