...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P5RSanet/P5RSa[]/soma/spk23  \
	      /P5IBdnet/P5IBd[]/{s}/Ex_ch9P5RSAMPA@all	    \
	      -relative			    \
	      -sourcemask box -1 -1  -1  1  1  1  \
	      -destmask   box -{destlim} -{destlim}  -1 {destlim}  {destlim}  1   \
	      -desthole   box -0.000001 -0.000001 -0.000001 0.000001 0.000001 0.000001 \
          -probability 0.02174*{P5RSa_P5IBd_prob}
...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P5RSanet/P5RSa[]/soma/spk23  \
	      /P5IBdnet/P5IBd[]/{s}/Ex_ch9P5RSNMDA@all	    \
	      -relative			    \
	      -sourcemask box -1 -1  -1  1  1  1  \
	      -destmask   box -{destlim} -{destlim}  -1 {destlim}  {destlim}  1   \
	      -desthole   box -0.000001 -0.000001 -0.000001 0.000001 0.000001 0.000001 \
...
rvolumedelay /P5RSanet/P5RSa[]/soma/spk23 -radial  {P5RSa_P5IBd_axdelayCV} -add -gaussian {P5RSa_P5IBd_axdelaystdev} {P5RSa_P5IBd_axdelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /P5IBdnet/P5IBd[]/{s}/Ex_ch9P5RSAMPA {P5RSa_P5IBd_syndelay} -add -gaussian {P5RSa_P5IBd_syndelaystdev} {P5RSa_P5IBd_syndelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /P5IBdnet/P5IBd[]/{s}/Ex_ch9P5RSNMDA {P5RSa_P5IBd_syndelay} -add -gaussian {P5RSa_P5IBd_syndelaystdev} {P5RSa_P5IBd_syndelaymaxdev}
