...
foreach s ({arglist {locations}})
    ...
    rvolumeconnect /P5IBanet/P5IBa[]/soma/spk6  \
          ...
          -probability 0.02326*{P5IBa_P6RSb_prob}
...
rvolumedelay /P5IBanet/P5IBa[]/soma/spk6 -radial  {P5IBa_P6RSb_axdelayCV} -add -gaussian {P5IBa_P6RSb_axdelaystdev} {P5IBa_P6RSb_axdelaymaxdev}
...
foreach s ({arglist {locations}})
    ...
    syndelay    /P6RSbnet/P6RSb[]/{s}/Ex_ch12P5IBAMPA {P5IBa_P6RSb_syndelay} -add -gaussian {P5IBa_P6RSb_syndelaystdev} {P5IBa_P6RSb_syndelaymaxdev}
